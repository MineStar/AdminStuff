...
import de.minestar.AdminStuff.commands.cmdDifficulty;
...
import de.minestar.AdminStuff.commands.cmdMobs;
    ...
    protected boolean createCommands() {
		...
		cmdList = new CommandList(
				...
				new cmdGlueHere("/gluehere", "<Player>",
						"adminstuff.commands.admin.gluehere"),

				// CLASSICMODE
				new cmdClassic("/classic", "[Player_1] ... [Player_N]",
						"adminstuff.commands.admin.classic"),

				// FLASH COMMANDS
				new cmdFlash("/flash", "", "adminstuff.commands.admin.flash"),
				new cmdFlash("/lightning", "",
						"adminstuff.commands.admin.flash"),

				// KICK COMMANDS
				new cmdKick("/kick", "<Player> [Message]",
						"adminstuff.commands.admin.kick"),
				new cmdKickAll("/kickall", "[Message]",
				...
				// KIT COMMAND
				new cmdKit("/kit", "<Name>",
						"adminstuff.commands.admin.usekit", kManager),
				new cmdListKits("/listkits", "",
						"adminstuff.commands.admin.listkits", kManager),
				...
				new cmdClearInventory("/clearinventory", "",
						"adminstuff.commands.user.clearinventory"),
				...
				new cmdFillChest("/fillchest", "[ItemID or Name][:SubID]",
						"adminstuff.commands.admin.fillchest"),
				new cmdStack("/stack", "", "adminstuff.commands.user.stack"),

				// MESSAGE COMMANDS
				new cmdBroadcast("/broadcast", "<Message>",
						"adminstuff.commands.admin.broadcast"),
				new cmdBroadcast("/cast", "<Message>",
						"adminstuff.commands.admin.broadcast"),
				new cmdMute("/mute", "<Player>",
						"adminstuff.commands.admin.mute"),
				new cmdMessage("/message", "<Player> <Message>",
						"adminstuff.commands.user.message"),
				new cmdMessage("/msg", "<Player> <Message>",
						"adminstuff.commands.user.message"),
				new cmdMessage("/m", "<Player> <Message>",
						"adminstuff.commands.user.message"),
				new cmdReply("/r", "<Message>",
						"adminstuff.commands.user.reply"),
				new cmdMe("/me", "<Message>", "adminstuff.commands.admin.me"),
				new cmdHideChat("/hidechat", "",
						"adminstuff.commands.admin.hidechat"),

				// RECIPIENT COMMANDS
				new cmdChat("/chat", "", "adminstuff.commands.user.chat",
						pManager),

				// USER COMMANDS
				new cmdAFK("/afk", "", "adminstuff.commands.user.afk", pManager),
				new cmdCompass("/compass", "",
						"adminstuff.commands.user.compass"),
				new cmdNickname("/nickname", "<Nickname> [Player]",
						"adminstuff.commands.admin.nickname", pManager),
				new cmdNickname("/nick", "<Nickname> [Player]",
						"adminstuff.commands.admin.nickname", pManager),

				// TIME & WEATHER COMMAND
				new cmdTime("/time", "<Time>", "adminstuff.commands.admin.time"),
				new cmdWeather("/weather", "<Weather>",
						"adminstuff.commands.admin.weather"),

				// MISC COMMANDS
				new cmdPing("/ping", "", "adminstuff.commands.admin.ping"),
				new cmdSeen("/seen", "<Player>",
						"adminstuff.commands.admin.seen"),

				// BLOCK COUNT
				new cmdBlockCount("/bcount", "",
						"adminstuff.commands.admin.count", pManager),
				new cmdMobs("/mobs", "", "adminstuff.commands.user.mobs"),

				// REMOVE ENTITYS
				// new cmdDeleteItem ("/delitem", "i[ItemID] r[Radius]",
				// "adminstuff.commands.admin.delitem"),
				new cmdButcher("/butcher", "[Radius]",
						"adminstuff.commands.admin.butcher"),

				new cmdToggleDownfall("/toggledownfall", "",
						"adminstuff.commands.admin.toggledownfall"),
