...
public enum Direction {
	...
	// @formatter:off
	N(338, 359, "Norden"), N_(0, 23, "Norden"), NE(23, 68, "Nord-Osten"), E(68,
			113, "Osten"), SE(113, 158, "Sued-Osten"), S(158, 203, "Sueden"), SW(
			203, 248, "Sued-West"), W(248, 293, "Westen"), NW(293, 338,
			"Nord-West");
	// @formatter:on
