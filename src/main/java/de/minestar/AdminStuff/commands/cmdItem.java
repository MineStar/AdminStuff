	...
	public void execute(String[] args, Player player) {
		...
		if (args.length == 2) {
			try {
				...
				PlayerUtils.sendError(player, ID, args[1]
		...
		PlayerUtils.sendInfo(player, "Du erhaelst " + amount + " mal "
				+ itemName);
		ConsoleUtils.printInfo(pluginName, "ITEM: " + player.getName()
				+ " himself : " + amount + " x " + itemName);
	}
}
